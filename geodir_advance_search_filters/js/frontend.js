...
function setusermarker_osm(new_lat, new_lon, map_id) {
    ...
    gdUmarker.setIcon(L.divIcon({
        ...
        html: '<div class="gd-user-marker-box"><div class="gd-user-marker-animate"></div><img class="gd-user-marker-img" src="' + geodir_advanced_search_js_msg.geodir_advanced_search_plugin_url + '/css/map_me.png' + '"></img></div>'
    }));

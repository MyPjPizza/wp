...
class GWPayPerWord extends GWPerk {
	...
	public function calculate_price( $price_field, $form ) {
		...
		$base_price     = rgar( $price_field, "{$this->slug}_base_price" );
		$base_count     = rgar( $price_field, "{$this->slug}_base_word_count" );
